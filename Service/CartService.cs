...
public class CartService
{
    ...
    public void SaveCartCheckout(List<CartItem> ls, string CHECKOUTKEY = "checkout")
    {
        var session = HttpContext.Session;
        string jsoncart = JsonConvert.SerializeObject(ls);
    ...
    public List<CartItem> GetCheckout(string CHECKOUTKEY = "checkout")
    {
    ...
    public void ClearCartCheckout(string CHECKOUTKEY = "checkout")
    {
        var session = HttpContext.Session;
